...
- [[04 - Governança & Manuais/03 - manual-redacao-linguagem-simples|Manual de Redação e Estruturação]] — orientações detalhadas de escrita e estrutura de páginas.
- [[05 - Conceitos & Variáveis/conceitos/linguagem-simples|Linguagem Simples]] — conceito e relação com carga cognitiva.
- [[05 - Conceitos & Variáveis/conceitos/usabilidade|Usabilidade]] — base complementar para avaliar facilidade de uso.
