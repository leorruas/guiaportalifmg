...
Esta página complementa [[04 - Governança & Manuais/guia-do-portal/04 - Sou editor/13 - Sou editor e quero montar conteúdo com blocos|como montar conteúdo com blocos]]. As capturas mostram a configuração e, quando disponível, o resultado publicado. Use-as como referência visual; os campos que aparecerem para você dependem do tipo de página e das permissões do grupo.
