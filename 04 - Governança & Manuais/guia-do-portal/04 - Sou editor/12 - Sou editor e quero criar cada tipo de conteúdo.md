# Sou editor e quero criar cada tipo de conteúdo
...
Crie notícias dentro da pasta de notícias apropriada. Use pasta de notícias para agregar conteúdo jornalístico; não a use como substituta de uma página estável de serviço.

## Pasta de processos seletivos e processo seletivo

Crie o processo na pasta correspondente ao tipo de seleção. Organize edital e documentos em uma coleção e exiba-os na página por um bloco de coleção.
