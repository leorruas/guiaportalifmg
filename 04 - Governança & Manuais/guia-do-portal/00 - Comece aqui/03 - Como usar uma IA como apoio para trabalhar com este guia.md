...
Use a IA para transformar uma dúvida em checklist, revisar um texto, comparar uma decisão com as orientações do guia ou explicar um procedimento em palavras mais simples. A decisão final continua sendo da pessoa responsável pelo conteúdo, pelo grupo ou pela publicação.
...
- Não invente links, permissões, telas, botões, campos ou procedimentos que não estejam no guia.
- Se o guia não trouxer a resposta, diga isso claramente e indique o que preciso confirmar com uma pessoa responsável.
- Separe o que posso fazer diretamente do que depende de editor, moderador, administrador ou validação institucional.
...
- se datas, nomes, documentos e páginas citados foram conferidos;
- se a IA avisou quando não tinha informação suficiente;
